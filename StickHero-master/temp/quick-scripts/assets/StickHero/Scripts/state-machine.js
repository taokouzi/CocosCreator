(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/StickHero/Scripts/state-machine.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7e42dZP3uxCS5nmxgOIHv9d', 'state-machine', __filename);
// StickHero/Scripts/state-machine.js
        ...
        observeEvents: function observeEvents(events, args, previousEvent) {
          ...
          if (observers.length === 0) {
            ...
            if (result && typeof result.then === 'function') {
              return result.then(this.observeEvents.bind(this, events, args, event)).catch(this.endTransit.bind(this));
